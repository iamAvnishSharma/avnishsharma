...
<html lang="en">
  ...
  <body>
    <div class="flex-w flex-str size1 overlay1">
      <div
        class="flex-w flex-col-sb wsize1 bg0 p-l-70 p-t-37 p-b-52 p-r-50 respon1"
      >
        <div class="wrappic1">
          <a href="#">
            <!-- <img src="images/icons/logo.png" alt="IMG" /> -->A
          </a>
        </div>
        ...
        <div class="w-full p-t-100 p-b-90 p-l-48 p-l-0-md">
          ...
          <p class="m2-txt1 p-b-46">
            Email me at avnishsharma@ducoux.com for Inquiry.
          </p>
